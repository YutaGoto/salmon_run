...
module Event::GeneratedAssociationMethods
  ...
  sig { params(value: ::Stage).void }
  def stage=(value); end

  sig { returns(::Weapon::ActiveRecord_Associations_CollectionProxy) }
  def weapons; end

  sig { params(value: T::Enumerable[::Weapon]).void }
...
class Event::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { params(args: T.untyped).returns(Event::ActiveRecord_Relation) }
  def by_stage_id(*args); end

  sig { params(args: T.untyped).returns(Event::ActiveRecord_Relation) }
  def by_weapon(*args); end

  sig { params(args: T.untyped).returns(Event::ActiveRecord_Relation) }
  def opening(*args); end
